...
```{r}
rm(list=ls())
WSO <- read_csv("/Users/howe/Desktop/WSO/kanzel_wso.csv")
...
# Rolling correlation can be used to examine how relationships between two datasets change over time.
 ...
 (loc <- paste0("/Users/howe/Desktop/WSO/", Ex, ver, part, yl, "By", xl, ilk, ".png"))
png(loc)
...
(main <- paste(part, yl,"vs", xl))
 (loc <- paste0("/Users/howe/Desktop/WSO/", Ex, ver, part, "Scatter", yl, "By", xl, ".png"))
